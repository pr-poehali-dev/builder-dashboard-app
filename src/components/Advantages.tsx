...
const advantages = [
  ...
  },
  {
    ...
    description: 'Большинство работ выполняем за 1-2 дня. Оперативная обратная связь на каждом этапе ремонта.',
  },
  {
    icon: 'Banknote',
  ...
  },
  {
    ...
    description: 'Находимся в Казани с удобным подъездом и бесплатной парковкой. Есть зона ожидания с Wi-Fi и кофе.',
  },
];
